...
<ProjectImage 
  ...
  alt="Establishing adaptive components"
  caption="Establishing adaptive components"
  size="full"
  position="center"
/>
...
<ProjectImage 
  ...
  alt="Establishing design tokens"
  caption="Establishing design tokens"
  size="full"
  position="center"
/>
...
<ProjectImage 
  src="/images/projects/mionext-4.jpg"
  alt="App Launch"
  caption="App Launch"
  size="full"
  position="center"
...
<ProjectImage 
  src="/images/projects/mionext-5.jpg"
  alt="Map View"
  caption="Map View"
  size="full"
  position="center"
...
<ProjectImage 
  src="/images/projects/mionext-6.jpg"
  alt="Event & Event details"
  caption="Event & Event details"
  size="full"
  position="center"
/>

<ProjectImage 
  src="/images/projects/mionext-7.jpg"
  alt="Trips & Trip details"
  caption="Trips & Trip details"
  size="full"
  position="center"
/>

<ProjectImage 
  src="/images/projects/mionext-8.jpg"
  alt="Devices & Devices details"
  caption="Devices & Devices details"
  size="full"
  position="center"
/>
...
- **Measured Engagement:**
OneSignal data shows monthly active users quickly surpassed **700**, confirming that the streamlined onboarding and refreshed UI are driving adoption.

- **Industry Recognition:**
The redesign captured the **2024 iF Design Award – User Experience**, validating our safety-first, token-driven approach.

- **What’s Next:**
With foldable devices gaining traction, we’ll extend our layout grid and component variants to deliver a seamless dual-pane experience on foldables.